# 🎓 Andrews University (AU) Doctor of Ministry (DMin) — Typst Template & CSL System (Українська версія)
...
└── README_UKR.md                                     # 📖 Ця документація (Українська)
```
...
#copyright-page(
  ...
  year: "2026",
  content: auto, // за замовчуванням: © Copyright by Taras Shevchenko 2026 \ Всі права захищено
)
```
